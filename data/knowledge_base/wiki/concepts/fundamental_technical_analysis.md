...
ファンダメンタルズ（財務・業績）分析とテクニカル（価格・指標）分析を組み合わせて投資判断を行う手法。
FA と Tech の両シグナルが確認されて初めてエントリー根拠が揃う。
...
| 2026-05-06 | [[tickers/GEHC]] | 中立 | FA+Tech確認済みでも市場変動に対応できなかった |
| 2026-05-06 | [[tickers/NKE]] | 失敗 | 分析が示す強気と実際の動きが乖離 |
